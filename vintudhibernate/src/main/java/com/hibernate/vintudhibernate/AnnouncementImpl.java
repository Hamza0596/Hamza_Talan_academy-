...
public class AnnouncementImpl {
	...
	public AnnouncementImpl(String title,String description,long categorie,double price,String photo,Date publication_Date,boolean disponibility_State,int viewNumber,String localisation,long user_id) {
		this.title=title;
		this.description=description;
		this.categorie=categorie;
		this.price=price;
	...
	public String toString() {
		return "AnnouncementImpl [id=" + id + ", title=" + title + ", description=" + description + ", categorie="
				+ categorie + ", price=" + price + ", photo=" + photo + ", publication_Date=" + publication_Date
				+ ", disponibility_State=" + disponibility_State + ", viewNumber=" + viewNumber + ", localisation="
				+ localisation + ", user_id=" + user_id + "]";
	}
