public class Main {
	...
	public static void main(String[] args) {
	    ...
	    Gl.déclarer_lions_non_dominant();
	    Gl.supprimer_predateurds();
	
	    Gl.afficher_caractéristiques_prédateurs_quilcontient();
	    
	    System.out.println("le couple introduit par defaut est le couple(l1 et l2)");
	    
	   
	    
	    
	    Gl.constituer_couple_dominant(l1, l2);
