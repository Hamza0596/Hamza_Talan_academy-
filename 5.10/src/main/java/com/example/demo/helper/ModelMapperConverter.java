...
public class ModelMapperConverter {
    ...
    public UserImpl toUser(UserDto userDto) {
        return modelMapper.map(userDto, UserImpl.class);
    }

    public UserDto toUserDto(UserImpl user) {
        return modelMapper.map(user, UserDto.class);
    }
    
    public AnnouncementImpl toAnnouncement(AnnouncementDto announcementDto) {
