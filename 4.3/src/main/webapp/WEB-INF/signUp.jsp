...
<body>
 ...
 <h1 style="color:blue;margin-left:3cm;margin-bottom:1cm;">signUp</h1>
   ...
   <c:choose>
    ...
    <c:when test="${ resultat==false }" > <p style="color:red;"> Email/phone Number is already exist</p></c:when>
