...
public class DepotAnnonces extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	     ...
	     Factory factory = new Factory();
	     /* Insertion de l'id via la session*/
	     HttpSession session = request.getSession();
	     int id = (int) session.getAttribute("id");
	     AnnouncementImpl An = new AnnouncementImpl(title,description,categoryy,priced,"photo",Date.valueOf("2020-12-05"),true,1,localisation,id);
